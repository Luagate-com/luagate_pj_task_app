...
- **Frontend** — https://prod-luagate-pj-taskapp-frontend-v3bbmayaea-an.a.run.app
- **API** — https://prod-luagate-pj-taskapp-api-v3bbmayaea-an.a.run.app

デモアカウント (`password123`) は `alice@example.com` / `bob@example.com` / `carol@example.com` の 3 つ。
